        ...
        <section className="relative w-full h-[500px] bg-gray-900 overflow-hidden">
            ...
            <div className="container mx-auto px-6 h-full flex items-center relative z-10">
                <div className="max-w-2xl text-white pl-0 md:pl-10">
                    ...
                    <p className="text-xs md:text-sm text-gray-300 mb-10 max-w-md font-medium tracking-wide leading-relaxed">
                        EVERY BOTTLE SUPPORTS SUSTAINABLE INITIATIVES, <br />
                        ALWAYS QUALITY, ALWAYS PURE. <br />
                        PURE CHANGE.
                    </p>
                    <a href="#" className="inline-block text-[10px] font-bold text-white border-b border-white/50 pb-1 hover:border-white uppercase tracking-[0.2em] transition-colors">
                        Shop
                    </a>
                </div>
            </div>
